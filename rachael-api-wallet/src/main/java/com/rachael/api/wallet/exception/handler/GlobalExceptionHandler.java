package com.rachael.api.wallet.exception.handler;
...
import com.rachael.api.wallet.exception.BadRequestException;
import com.rachael.api.wallet.exception.ErrorResponse;
import com.rachael.api.wallet.exception.ResourceNotFoundException;
import com.rachael.api.wallet.exception.UnauthorizedException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(ResourceNotFoundException ex) {
        return buildErrorResponse(ErrorMessages.NOT_FOUND, HttpStatus.NOT_FOUND);
    }
