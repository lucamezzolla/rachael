...
public class SuccessMessages {
	...
	//UTENTE
	public static final String USER_FOUND = "Utente trovato con successo.";
	public static final String USER_CREATED = "Utente creato con successo.";
	public static final String USER_UPDATED = "Utente aggiornato con successo.";
